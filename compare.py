...
# Load in user data
f1_path = os.path.join(DATA_DIR, MENTION_ID + "-" + labeler1 + ".csv")
f2_path = os.path.join(DATA_DIR, MENTION_ID + "-" + labeler2 + ".csv")
file1 = pd.read_csv(f1_path, index_col=0, dtype={'patent_id': str})
file2 = pd.read_csv(f2_path, index_col=0, dtype={'patent_id': str})
...
output_path = os.path.join(DATA_DIR, MENTION_ID + "-difference.csv")
